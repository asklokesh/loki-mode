...
```bash
python -m swebench.harness.run_evaluation     --predictions /Users/lokesh/git/claudeskill-loki-mode/benchmarks/results/2026-01-05-01-24-17/swebench-predictions.json     --max_workers 4
```
